---
title: "Compliance & Governance Context Brief"
domain: "compliance-governance"
version: "1.0"
status: "APPROVED"
owner: "James Rodriguez (Compliance Officer)"
approved_by: "james.rodriguez@example.com"
approved_at: "2025-12-01T09:25:00Z"
created: "2025-11-28"
updated: "2025-12-01"
...
# Compliance & Governance Context Brief
Project: Medication Adherence Platform

This document provides the structured compliance and governance context required
to generate:

- scd:project:hipaa-compliance
- scd:project:soc2-controls
- scd:project:audit-requirements
- scd:project:policy-enforcement

It should be completed early in the Intent phase, after the Business Context and
in parallel with Architecture and Data-Provenance.
